...
function getDiffImage(img_online, img_design, test, need_diff_image) {
  return new _promise2.default(function (res, rej) {
    ...
    function doneReading() {
      ...
      if (need_diff_image) {
        diff.pack().pipe(_fs2.default.createWriteStream(test.path + '/' + test.viewport[0] + 'x' + test.viewport[1] + '.diff.png'));
      }
...
exports.default = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(url, tests) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return _context3.abrupt('return', _promise2.default.all(tests.map(function () {
              var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(test) {
                var result, img_online, img_design, score, isSimilar;
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        result = {};
                        _context2.next = 3;
                        return _screen2.default.screenshot(url, test.viewport, test.path);

                      case 3:
                        img_online = _context2.sent;
                        img_design = test.design;
                        _context2.next = 7;
                        return getDiffImage(img_online, img_design, test, opts.need_diff_image);
                      ...
                      case 10:
                        isSimilar = _context2.sent;

                        if (opts.need_score) {
                          result.score = score;
                        }
                        return _context2.abrupt('return', { score: score, isSimilar: isSimilar });
